...
def main():
    ...
    parser.add_argument('--building_height', type=int, default=19, help='building height ')
    parser.add_argument('--max_people_in_floor', type=int, default=20, help='maximum people in one floor')
    parser.add_argument('--max_people_in_elevator', type=int, default=20, help='maximum people in one elevator')
